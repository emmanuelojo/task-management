    ...
    <div class="grid gap-4">
      <div class="grid gap-1">
        ...
        <input
          ...
          class="border-none outline-none rounded-md placeholder:pl-1 placeholder:text-xs text-sm p-1"
        />
      </div>
      <div class="grid gap-1">
        ...
        <div>
          <div class="flex flex-col">
              ...
              <div class="flex flex-col gap-2">
                ...
                >
                  <input
                    ...
                    class="w-[95%] mr-2 border-none rounded-md placeholder:pl-1 placeholder:text-xs text-sm p-1"
                  />
                  <i
                    @click="removeSubTask(subTask.id)"
                    class="fa fa-times text-n-grey-text cursor-pointer"
                  ></i>
                </div>
              </div>
            </transition>
            <input
              ...
              v-model="newSubTask"
              placeholder="e.g Make coffee"
              class="flex flex-grow-1 border-none outline-none rounded-md placeholder:pl-1 placeholder:text-xs text-sm p-1"
              :class="subTasks.length ? 'mt-2' : 'mt-0'"
            />
          </div>
          <div
            @click.prevent="addSubTask"
            class="w-full mt-4 py-2 flex justify-center items-center text-n-purple bg-white hover:text-white hover:bg-n-purple rounded-3xl cursor-pointer"
          >
      ...
      <div
        @click="handleSubmit"
        class="w-full py-2 flex justify-center items-center bg-n-purple text-white rounded-3xl hover:scale-105 cursor-pointer"
      >
